...
export ORDERER_ADDRESS=192.168.42.79:7006
export ORDERER_TLS_CA=/vars/keyfiles/ordererOrganizations/property.com/orderers/orderer1.property.com/tls/ca.crt
...
jq '.channel_group.groups.Application.groups."registrar-property-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "192.168.42.79","port": 7002}]},"version": "0"}}' propertychannel_current_config.json > propertychannel_modified_anchor_config.json
